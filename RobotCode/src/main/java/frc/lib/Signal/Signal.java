...
public class Signal {
  ...
  public Signal(String name_in, String units_in) {
    ...
    nt4ValTopic =
        NT4Server.getInstance()
            .publishTopic(
                this.getNT4ValueTopicName(), NT4TypeStr.FLOAT_64, SignalWrangler.getInstance());
    nt4UnitsTopic =
        NT4Server.getInstance()
            .publishTopic(
                this.getNT4UnitsTopicName(), NT4TypeStr.STR, SignalWrangler.getInstance());
  ...
  public String getNT4UnitsTopicName() {
    return SignalUtils.nameToNT4UnitsTopic(this.name);
  }
}
