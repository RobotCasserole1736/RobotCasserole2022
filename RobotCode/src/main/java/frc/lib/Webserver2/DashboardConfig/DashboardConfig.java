...
public class DashboardConfig {
  ...
  public void addAutoChooser(
      AutoModeList autoList, double xPos, double yPos, double sizeScaleFactor) {
  ...
  public void addCamera(
      String name, String streamURL, double xPos, double yPos, double sizeScaleFactor) {
  ...
  public void addText(
      String nt4Topic_in, String name, double xPos, double yPos, double sizeScaleFactor) {
  ...
  public void addSwerveState(
      SwerveStateTopicSet[] topics_in,
      String name,
      double xPos,
      double yPos,
      double sizeScaleFactor) {
  ...
  public void addFieldPose(
      String topicPrefix, String name, double xPos, double yPos, double sizeScaleFactor) {
    var w = new FieldPose();
    w.idx = widgetList.size();
    w.xPos = xPos;
    w.yPos = yPos;
