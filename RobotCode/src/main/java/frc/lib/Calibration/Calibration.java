...
public class Calibration {
  ...
  private void commonConstructor() {
    ...
    calUnitsTopic =
        NT4Server.getInstance()
            .publishTopic(this.getUnitsTopic(), NT4TypeStr.STR, CalWrangler.getInstance());
    calMinTopic =
        NT4Server.getInstance()
            .publishTopic(this.getMinTopic(), NT4TypeStr.FLOAT_64, CalWrangler.getInstance());
    calMaxTopic =
        NT4Server.getInstance()
            .publishTopic(this.getMaxTopic(), NT4TypeStr.FLOAT_64, CalWrangler.getInstance());
    calDefaultTopic =
        NT4Server.getInstance()
            .publishTopic(this.getDefaultTopic(), NT4TypeStr.FLOAT_64, CalWrangler.getInstance());
    calValueTopic =
        NT4Server.getInstance()
            .publishTopic(this.getValueTopic(), NT4TypeStr.FLOAT_64, CalWrangler.getInstance());
  ...
  String getValueTopic() {
    return "/Calibrations/" + this.name + "/Value";
  }

  String getDefaultTopic() {
    return "/Calibrations/" + this.name + "/Default";
  }

  String getUnitsTopic() {
    return "/Calibrations/" + this.name + "/Units";
  }

  String getMinTopic() {
    return "/Calibrations/" + this.name + "/Min";
  }

  String getMaxTopic() {
    return "/Calibrations/" + this.name + "/Max";
  }
}
