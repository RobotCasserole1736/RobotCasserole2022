...
public class Dashboard {
  ...
  public Dashboard(Webserver2 ws_in) {
    ...
    // d.addCircularGauge(SignalUtils.nameToNT4ValueTopic("db_systemPressure"), "System Press",
    // "PSI", 0.0, 150.0, 90.0, 130, LEFT_COL, ROW1, 1.0);
    // d.addLineGauge(SignalUtils.nameToNT4ValueTopic("db_visionTargetAngle"), "Vision Tgt Angle",
    // "deg", -30, 30, -2.5, 2.5, CENTER_COL, ROW1, 1.0);
    // d.addCircularGauge(SignalUtils.nameToNT4ValueTopic("db_shooterSpeed"), "Shooter Speed",
    // "RPM", 0, 6000, 4500, 5700, RIGHT_COL, ROW1, 1.0);

    // d.addText(SignalUtils.nameToNT4ValueTopic("db_shotsTaken"), "Shots Taken", CENTER_COL,
    // ROW1+10, 1.0);
    // d.addText(SignalUtils.nameToNT4ValueTopic("db_shooterSetpoint"), "Shooter Setpoint",
    // CENTER_COL, ROW1+20, 1.0);
    ...
    d.addIcon(
        SignalUtils.nameToNT4ValueTopic("db_masterCaution"),
        "Master Caution",
        "#FF0000",
        "icons/alert.svg",
        CENTER_COL - 6,
        ...
        1.0);
    d.addIcon(
        SignalUtils.nameToNT4ValueTopic("db_visionTargetVisible"),
        "Vision Target Visible",
        "#00FF00",
        "icons/vision.svg",
        CENTER_COL,
        ROW2,
        1.0);
    // d.addIcon(SignalUtils.nameToNT4ValueTopic("db_climberUpperLimit"),"Climber Upper Limit",
    // "#FFFF00", "icons/upperLimit.svg", CENTER_COL+6, ROW2, 1.0);

    // d.addIcon(SignalUtils.nameToNT4ValueTopic("db_shooterSpoolup"),"Shooter Spoolup", "#FFFF00",
    // "icons/speed.svg", CENTER_COL-6, ROW2+5, 1.0);
    // d.addIcon(SignalUtils.nameToNT4ValueTopic("db_conveyorFull"),"Conveyor Full", "#00FF00",
    // "icons/gear.svg", CENTER_COL, ROW2+5, 1.0);
    // d.addIcon(SignalUtils.nameToNT4ValueTopic("db_climberLowerLimit"),"Climber Lower Limit",
    // "#FFFF00", "icons/lowerLimit.svg", CENTER_COL+6, ROW2+5, 1.0);

    // d.addSound(SignalUtils.nameToNT4ValueTopic("db_highGroundAcq"), "High Ground",
    // "sfx/highground.mp3", false);
