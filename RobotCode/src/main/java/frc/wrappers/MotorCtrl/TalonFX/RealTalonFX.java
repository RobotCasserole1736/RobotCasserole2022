...
public class RealTalonFX extends AbstractSimmableMotorController {
  ...
  public RealTalonFX(int can_id) {
    ...
    _talon.configSelectedFeedbackSensor(TalonFXFeedbackDevice.IntegratedSensor, 0, TIMEOUT_MS);
  ...
  public void setClosedLoopCmd(double velocityCmd_radpersec, double arbFF_V) {
    var arbFF_demand =
        arbFF_V * 12.0; // TODO - base off of battery voltage rather than assuming 12.0
