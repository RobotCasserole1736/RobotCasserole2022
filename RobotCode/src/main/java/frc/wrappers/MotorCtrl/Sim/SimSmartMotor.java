...
/**
 * CTRE doesn't currently support simulating the internal functionality of a TalonFX. We provide a
 * wrapper and interface abstraction here to enable simulation through a transparent wrapper layer
 * in robot code.
 */
